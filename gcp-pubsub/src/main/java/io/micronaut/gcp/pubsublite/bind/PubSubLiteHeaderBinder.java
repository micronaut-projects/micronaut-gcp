...
import io.micronaut.gcp.pubsub.bind.PubSubAttributesConvertibleValues;
...
/**
 * Binds an argument annotated with {@link Header} annotation. The target type
 * must be supported by the {@link ConversionService}. PubSub attributes are always of type
 * String.
 *
 * Based on {@link io.micronaut.gcp.pubsub.bind.PubSubHeaderBinder}
 *
 * @author Jacob Mims
 * @since 2.2.0
 */
@Singleton
public class PubSubLiteHeaderBinder implements PubSubLiteAnnotatedArgumentBinder<Header> {

    private final ConversionService conversionService;

    public PubSubLiteHeaderBinder(ConversionService conversionService) {
