 ...
 * {@link PubSubMessageSerDes} to deserialize the contents of the PubSubMessage data.
 *
 * Based on {@link io.micronaut.gcp.pubsub.bind.PubSubBodyBinder}
 *
 * @author Jacob Mims
 * @since 2.2.0
 */
@Singleton
public class PubSubLiteBodyBinder implements PubSubLiteAnnotatedArgumentBinder<Body> {

    private final PubSubMessageSerDesRegistry serDesRegistry;

    public PubSubLiteBodyBinder(PubSubMessageSerDesRegistry serDesRegistry) {
    ...
    @Override
    public BindingResult<Object> bind(ArgumentConversionContext<Object> context, PubSubLiteConsumerState state) {
