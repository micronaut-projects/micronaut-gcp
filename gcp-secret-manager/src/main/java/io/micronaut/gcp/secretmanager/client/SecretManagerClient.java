...
public interface SecretManagerClient {
     ...
     */
    @SingleResult
    Publisher<VersionedSecret> getSecret(String secretId);
     ...
     */
    @SingleResult
    Publisher<VersionedSecret> getSecret(String secretId, String version);
     ...
     */
    @SingleResult
    Publisher<VersionedSecret> getSecret(String secretId, String version, String projectId);
