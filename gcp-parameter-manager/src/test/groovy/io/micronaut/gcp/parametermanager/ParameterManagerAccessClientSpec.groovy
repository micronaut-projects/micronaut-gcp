...
class ParameterManagerAccessClientSpec extends Specification {

    void "get method for missing parameter"() {
        ApplicationContext context = ApplicationContext.run(["spec.name": "ParameterManagerAccessClientSpec", "gcp.projectId": "first-gcp-project"])
    ...
    void "render method for missing parameter"() {
        ApplicationContext context = ApplicationContext.run(["spec.name": "ParameterManagerAccessClientSpec", "gcp.projectId": "first-gcp-project"])
        def client = context.getBean(ParameterManagerAccessClient)
        when:
