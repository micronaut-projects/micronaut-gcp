...
If you need startup configuration import, use the distributed configuration support described in <<secretManager/distributedConfiguration.adoc#, Distributed Configuration>>. The client APIs described here are for direct application code access to secrets.
