...
snippet::io.micronaut.gcp.pubsub.subscriber.ContentTypePushSubscriberSpec[tags="clazzBegin, injectClient, testMethodBegin, testMethodEnd, clazzEnd", source="test"]
